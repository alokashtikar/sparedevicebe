...
variable "cognito_client_investors_callback" {
  default = "https://qa-investor.bitz-solutions.com/cognito"
}

variable "cognito_client_investors_signout" {
  default = "https://qa-investor.bitz-solutions.com"
}

variable "cognito_client_backoffice_callback" {
  default = "https://qa-backoffice.bitz-solutions.com/cognito"
}

variable "cognito_client_backoffice_signout" {
  default = "https://qa-backoffice.bitz-solutions.com"
}

variable "bitz_backoffice_domain" {
  default = "qa-backoffice.bitz-solutions.com"
}
